...
extern void     SSEPerspective          ( GXmat4_t*   ret, float fov,        float aspect, float near, float far ); // ✅ Creates a camera object to render a scene
void            computeProjectionMatrix ( GXCamera_t* camera );                                                     // ✅ Computes an updated projection matrix
extern void     SSEView                 ( GXvec3_t*   eye, GXvec3_t* target, GXvec3_t* up, GXmat4_t* result );
